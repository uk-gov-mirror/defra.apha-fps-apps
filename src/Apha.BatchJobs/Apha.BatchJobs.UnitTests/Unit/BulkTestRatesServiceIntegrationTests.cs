...
/// <see cref="BulkTestRatesService"/> applies changes inside a single
/// transaction against SELECT ... FOR UPDATE-locked live rows, using frozen staging
/// (calculated_action, effective_new_rate). Tests use explicit
