...
namespace Apha.PACT.DataAccess.Data
{
    public class ProjectViewMap : IEntityTypeConfiguration<ProjectView>
    {
        ...
        {
            entity.HasNoKey().ToView("vtlkpproject", "fps");
            ConfigureMoneyColumns(entity);
            ConfigureStringColumns(entity);
            ConfigureDateColumns(entity);
            ConfigureNumericColumns(entity);
        }
        ...
        private static void ConfigureStringColumns(EntityTypeBuilder<ProjectView> entity)
        {
            ...
            entity.Property(e => e.Contract).HasMaxLength(50).HasColumnName("contract");
            entity.Property(e => e.CostBookNo).HasMaxLength(50).HasColumnName("costbookno");
            entity.Property(e => e.Customer).HasMaxLength(50).HasColumnName("customer");
            entity.Property(e => e.Disease).HasMaxLength(50).HasColumnName("disease");
            entity.Property(e => e.Dt2Username).HasMaxLength(50).HasColumnName("dt2username");
            entity.Property(e => e.IncomeAccountCode).HasMaxLength(50).HasColumnName("incomeaccountcode");
            entity.Property(e => e.Manager).HasMaxLength(50).HasColumnName("manager");
            entity.Property(e => e.OracleProjectCode).HasMaxLength(50).HasColumnName("oracleprojectcode");
            entity.Property(e => e.OwningRc).HasMaxLength(50).HasColumnName("owningrc");
            entity.Property(e => e.ParentProject).HasMaxLength(20).HasColumnName("parentproject");
            entity.Property(e => e.Program).HasMaxLength(10).HasColumnName("program");
            entity.Property(e => e.ProjectGroup).HasMaxLength(50).HasColumnName("projectgroup");
            entity.Property(e => e.ProjectParent).HasMaxLength(50).HasColumnName("projectparent");
            entity.Property(e => e.ProjectStatus).HasMaxLength(50).HasColumnName("projectstatus");
            entity.Property(e => e.ProjectTitle).HasMaxLength(200).HasColumnName("projecttitle");
            entity.Property(e => e.ShortTitle).HasMaxLength(30).HasColumnName("shorttitle");
            entity.Property(e => e.SubAccountCode).HasMaxLength(50).HasColumnName("subaccountcode");
            entity.Property(e => e.UserEmail).HasMaxLength(255).HasColumnName("useremail");
        }

        private static void ConfigureDateColumns(EntityTypeBuilder<ProjectView> entity)
        {
            entity.Property(e => e.DateCosted).HasColumnType("timestamp without time zone").HasColumnName("datecosted");
            entity.Property(e => e.DateCreated).HasColumnType("timestamp without time zone").HasColumnName("datecreated");
        }

        private static void ConfigureNumericColumns(EntityTypeBuilder<ProjectView> entity)
        {
            entity.Property(e => e.CaseWorkSub).HasPrecision(5, 4).HasColumnName("caseworksub");
